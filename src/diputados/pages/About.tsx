export const About = () => {
  return (
    <div className="min-h-screen mt-24 ml-4 mr-4 text-justify animate__animated animate__fadeIn">
      ...
      <h3 className="font-bold">¿Quiénes la Componen? </h3>
      <p className="pl-2 italic">
      ...
      <h3 className="font-bold">¿Cuales son sus funciones?</h3>
      <h3 className="pl-2 italic">
      ...
      <ul>
        ...
        <li>* Acordar subsidios a municipios.</li>
        <li>
          * Aprobar o desechar tratado celebrados con la nación, provincias o
          estados internacionales.
        </li>
        <li>
          * Debatir: Esto tiene en la legislatura un rol primordial para la toma
          de decisiones, cada legislador expresa libremente sus ideas y
          propuestas sometiéndolas a discusión con sus pares para optimizarlas.
        </li>
        <li>
        ...
        <li>* Dictar la ley electoral y la de los partidos políticos.</li>
        <li>* Prestar o denegar acuerdos para nombrar funcionarios.</li>
        <li>
          * Controlar a los otros poderes mediante Pedidos de Informe,
          Interpelaciones, Investigaciones, etc.
        </li>
      </ul>
      <h3 className="font-bold">¿Quienes son los Legisladores? </h3>
      <p className="ml-2 italic">
        Los legisladores son los Diputados, son los representantes del pueblo,es
        decir los ciudadanos elegidos por el pueblo para integrar el Poder
        Legislativo. Duran cuatro años en su cargo y pueden ser reelegidos. Los
        requisitos para ser elegido diputado son:
      </p>
      <ul>
        <li>
        ...
        <li>
          * Ser nativo de la provincia o tener 3 años de residencia inmediata en
          ella.
        </li>
        <li>
          * No podrán se diputados los eclesiásticos regulares ni los militares
          en servicio activo.
        </li>
      </ul>
      <h3 className="font-bold">Derechos y Obligaciones de los Legisladores</h3>
      <p className="ml-2 italic">
